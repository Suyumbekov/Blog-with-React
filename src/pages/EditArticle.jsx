...
export default function EditArticle({ user }) {
  ...
  const {
    ...
    defaultValues: {
      ...
      short: article?.article.description,
        ...
        >
          <div className="mb-3">
            ...
            <input
              ...
              className="appearance-none border rounded w-full text-base text-counter placeholder:text-placeholder py-2 px-3 leading-tight focus:outline-none focus:shadow-outline"
              id="title"
              type="text"
              placeholder="Title"
            />
          ...
          <div className="mb-3">
            ...
            <textarea
              ...
              className="appearance-none border rounded w-full text-base text-counter placeholder:text-placeholder py-2 px-3 h-[168px] focus:outline-none focus:shadow-outline"
              id="content"
              placeholder="Text"
            />
            {errors.content && (
          ...
          <div>
            ...
            {tags.map((tag, index) => (
              <div key={index} className="mb-[5px]">
                <span className="inline-block text-counter border rounded w-[300px] text-base py-2 px-3">
                  {tag}
                </span>
                <button
...
export const articleEditLoader = async ({ params }) => {
  const { slug } = params;
